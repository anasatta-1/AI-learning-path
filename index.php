...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['student_id'])) {
    ...
    // SQL Protection & Input Sanitization
    if (!empty($submittedStudentId) && !preg_match('/^[a-zA-Z0-9_-]+$/', $submittedStudentId)) {
        $loginError = 'Invalid student ID format. Please use alphanumeric characters.';
    } else {
